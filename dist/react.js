...
export var REfxField = function (_a) {
    ...
    var _e = rest.initialValue, initialValue = _e === void 0 ? initialValues[name] || fieldConfigDefault.initialValue : _e, _f = rest.parse, parse = _f === void 0 ? fieldConfigDefault.parse : _f, _g = rest.format, format = _g === void 0 ? fieldConfigDefault.format : _g, _h = rest.validators, validators = _h === void 0 ? formValidations[name] || fieldConfigDefault.validators : _h, _j = rest.validateOnBlur, validateOnBlur = _j === void 0 ? formConfig.validateOnBlur : _j, _k = rest.validateOnChange, validateOnChange = _k === void 0 ? formConfig.validateOnChange : _k, props = __rest(rest, ["initialValue", "parse", "format", "validators", "validateOnBlur", "validateOnChange"]);
